...
class CreateProductProjectNamesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_project_names', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('product_project_names');
    }
}
