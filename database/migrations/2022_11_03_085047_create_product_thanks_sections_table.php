...
class CreateProductThanksSectionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_thanks_sections', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('product_thanks_sections');
    }
}
