...
class CreateLayoutiThingsPagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('layouti_things_pages', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('layouti_things_pages');
    }
}
