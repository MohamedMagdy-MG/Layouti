...
class CreateDesignAppChallengesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('design_app_challenges', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('design_app_challenges');
    }
}
