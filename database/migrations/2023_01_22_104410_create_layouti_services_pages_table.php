...
class CreateLayoutiServicesPagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('layouti_services_pages', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('layouti_services_pages');
    }
}
