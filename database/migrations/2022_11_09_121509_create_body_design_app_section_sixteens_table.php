...
class CreateBodyDesignAppSectionSixteensTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('body_design_app_section_sixteens', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('body_design_app_section_sixteens');
    }
}
