...
class CreateSeoPageContactPagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('seo_page_contact_pages', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('seo_page_contact_pages');
    }
}
