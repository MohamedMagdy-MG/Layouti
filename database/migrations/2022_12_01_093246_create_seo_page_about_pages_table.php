...
class CreateSeoPageAboutPagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('seo_page_about_pages', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('seo_page_about_pages');
    }
}
